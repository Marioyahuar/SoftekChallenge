...
export class TraitExtractionService {
  ...
  private extractEnvironmentTraits(character: StarWarsCharacter): string[] {
    ...
    if (
      climate.includes("ocean") ||
      climate.includes("aquatic") ||
      terrain.includes("ocean")
    ) {
      traits.push("ocean");
    }
